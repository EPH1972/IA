"""
Genera SC1_RL_TorchCraft_PPO.ipynb a partir del contenido del README.
...
def mk_code(src):
    return {"cell_type": "code", "execution_count": None, "id": uuid.uuid4().hex[:16],
            "metadata": {}, "outputs": [], "source": src}

cells = []

# ── Celda 1: Título + Resumen ──────────────────────────────────────────────
cells.append(mk_md([
...
# ── Celda 6: Comunicación modelo-BWAPI ────────────────────────────────────
cells.append(mk_md([
...
# ── Celda 8: Observación y Acciones ───────────────────────────────────────
cells.append(mk_md([
...
# ── Celda 16: Recursos y Trabajo Futuro ───────────────────────────────────
cells.append(mk_md([
...
# ── Construir y guardar el notebook ──────────────────────────────────────
notebook = {
    "nbformat": 4,
    "nbformat_minor": 5,
    "metadata": {
        ...
        "colab": {
            "name": "SC1_RL_TorchCraft_PPO.ipynb",
            "provenance": [],
            "toc_visible": True,
        }
    },
...
output_path = "SC1_RL_TorchCraft_PPO.ipynb"
...
print(f"  Markdown: {md_cells}  |  Codigo: {code_cells}")
